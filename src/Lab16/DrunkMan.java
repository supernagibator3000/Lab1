...
public class DrunkMan {
    ...
    private void game(){
        ...
        while (true){
            ...
            // Вывод раунда
            //System.out.print("round: " + (rounds + 1) + " ");
            //System.out.println("first: " + firstPlayerCard + " second: " + secondPlayerCard);
            //outputDecks();
    ...
    private void randomInput(){
        ...
        while (counter < 10){
            ...
            if (!check[buff]){
                ...
                // Значение добавленной карты и количество добавленных карт
                //System.out.println("buff: " + buff + " counter: " + counter);
            }
        }
    }
